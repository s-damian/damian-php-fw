...
class Cookie implements CookieInterface
{
     ...
     * @param int $value - Valeur du cookie.
     ...
     */
    public function put(string $name, $value, int $minutes = null, string $path = null, string $domain = null, bool $secure = null, bool $httponly = null)
    {
        if ($minutes === 0) {
            $expireValue = 0;
        } elseif ($minutes === null) {
    ...
    public function destroy(string $name, string $path = null, string $domain = null): void
    {
        ...
        $this->put($name, null, -2628000, $pathValue, $domainValue);
    }
}
